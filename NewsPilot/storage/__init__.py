...
from NewsPilot.storage.local import LocalStorageBackend
from NewsPilot.storage.manager import StorageManager, get_storage_manager

# 远程后端可选导入（需要 boto3）
try:
    from NewsPilot.storage.remote import RemoteStorageBackend
    HAS_REMOTE = True
except ImportError:
