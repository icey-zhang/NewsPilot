...
from InfoAgent.core.frequency import matches_word_groups, _word_matches
...
def count_rss_frequency(
    ...
    """
    from InfoAgent.utils.time import format_iso_time_friendly
    from InfoAgent.core.frequency import explain_word_group_match
    ...
    debug_filter = os.environ.get("TREND_RSS_DEBUG_FILTER", "").strip().lower() in {"1", "true", "yes", "on"}
    debug_filter_max = 30
    try:
        debug_filter_max = int(os.environ.get("TREND_RSS_DEBUG_FILTER_MAX") or 30)
    except Exception:
        debug_filter_max = 30
