...
from InfoAgent.storage.base import StorageBackend, NewsItem, NewsData, RSSItem, RSSData
from InfoAgent.utils.time import (
    get_configured_time,
    format_date_folder,
    format_time_filename,
)
from InfoAgent.utils.url import normalize_url
...
class RemoteStorageBackend(StorageBackend):
    ...
    def __init__(
        ...
        # 创建临时目录
        self.temp_dir = Path(temp_dir) if temp_dir else Path(tempfile.mkdtemp(prefix="InfoAgent_"))
