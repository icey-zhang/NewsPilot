...
from InfoAgent.report import (
    clean_title,
    prepare_report_data,
    generate_html_report,
    render_html_content,
)
from InfoAgent.notification import (
...
from InfoAgent.storage import get_storage_manager
...
class AppContext:
    ...
    def render_html(
        ...
        return render_html_content(
            ...
            show_rss_new_items=self.config.get("SHOW_RSS_NEW_SECTION", True),
